...
export const CATEGORIES: Category[] = [
    ...
    { id: 4, name: 'Mudanzas Fletes y Comisiones', icon: Truck, description: 'Llevar muebles y cajas de acá para allá.', imageUrl: getImage('cat-mudanzas').imageUrl, imageHint: getImage('cat-mudanzas').imageHint },
...
export const CATEGORY_SPECIALTIES: CategorySpecialties = {
  ...
  4: { name: 'Mudanzas Fletes y Comisiones', specialties: ['Mudanzas locales', 'Fletes y mini fletes', 'Embalaje profesional', 'Peones para carga y descarga', 'Traslado de objetos pesados', 'Servicio con soga', 'Mudanzas a todo el país', 'Desarme y arme de muebles', 'Traslado de oficinas', 'Repartos y logística'] },
...
export const CATEGORY_KEYWORDS: { [key: number]: { name: string; keywords: string[] } } = {
  ...
  4: { name: 'Mudanzas Fletes y Comisiones', keywords: MUDANZAS_KEYWORDS },
...
export const CATEGORY_SYNONYMS = {
    ...
    'flete': 'Mudanzas Fletes y Comisiones',
    'comisionista': 'Mudanzas Fletes y Comisiones',
    'albañil': 'Albañilería',
    'herrero': 'Herrería',
